...
export function ShoppingView() {
  ...
  const categories = Object.keys(grouped).sort((a, b) =>
    a === 'Sonstiges' ? 1 : b === 'Sonstiges' ? -1 : a.localeCompare(b)
  )
      ...
      <main className="flex-1 px-4 py-4 max-w-xl mx-auto w-full">
        {loading ? (
          ...
          <div className="text-center mt-20">
            <p className="text-gray-400 text-lg">Liste ist leer</p>
            <p className="text-gray-300 text-sm mt-1">Füge einen Artikel hinzu</p>
          </div>
        ) : (
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/40 flex items-end sm:items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl w-full max-w-md p-5 shadow-xl">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">Neuer Artikel</h2>
            <input
              autoFocus
              type="text"
              placeholder="Artikel…"
