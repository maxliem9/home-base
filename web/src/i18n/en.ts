...
export const en: Messages = {
  ...
  time: {
    ...
    split: 'Split',
    splitRunning: 'Split running timer',
    ...
    splitPart1: 'Part 1:',
    splitPart2: 'Part 2:',
    splitHintRunning: 'Splits the running timer at the cut time: part 1 ends there and the timer keeps running after the break — for the forgotten break. Cut time and break must lie in the past.',
    splitInvalidCut: 'The cut time must be between start and end',
    splitInvalidCutRunning: 'The cut time must be between start and now',
    splitInvalidBreak: 'Enter the break in minutes (e.g. 30)',
    splitBreakTooLong: 'The break must end before the entry ends',
    splitBreakTooLongRunning: 'The break must end before now',
  ...
  settings: {
    ...
    aboutVersionHint: 'Which build is running here. The value in brackets is the build\'s commit.',
    aboutWeb: 'Web app',
    aboutBackend: 'Backend',
    aboutBackendUnavailable: 'unavailable',
    aboutVersionMismatch: 'Web app and backend are running different versions. After a deployment, reloading the page usually helps.',
    time: 'Time tracking',
