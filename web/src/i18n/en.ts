...
export const en: Messages = {
  ...
  notes: {
    ...
    // file attachments (#431): arbitrary files (PDF, office, text …) on a note
    attachments: 'Attachments',
    addAttachment: 'Attach file',
    removeAttachment: 'Remove attachment',
    openAttachment: 'Open',
    attachmentTooLarge: 'File is too large (max. 10 MB).',
    attachmentBadType: 'File type not allowed (PDF, text, office …).',
    attachmentUploadFailed: 'Upload failed.',
    attachmentsSomeFailed: '{count} file(s) could not be uploaded.',
    attachmentDeleteTitle: 'Delete attachment?',
    attachmentDeleteConfirmNamed: '"{name}" will be deleted. This cannot be undone.',
    attachmentDeleteConfirmUnnamed: 'The attachment will be deleted. This cannot be undone.',
    attachmentDeleteFailed: 'Attachment could not be deleted.',
    attachmentDownloadFailed: 'Attachment could not be downloaded.',
  ...
  settings: {
    ...
    // Einkaufskategorien-Unterseite (#411): household-wide grocery category catalog (the
    // shopping-list headers) + auto-assignment rules (item name → category).
    shopping: 'Shopping categories',
    shoppingTitle: 'Shopping categories',
    shoppingHint: 'Categories for the shopping list and auto-assignment rules for newly added items. Applies to the whole household.',
    // Categories card: list, add, edit, reorder, delete.
    shoppingCatsTitle: 'Categories',
    shoppingCatsHint: 'The headers the shopping list is grouped by.',
    shoppingCatsEmpty: 'No categories yet.',
    shoppingCatAdd: 'Add category',
    shoppingCatEdit: 'Edit category',
    shoppingCatNew: 'New category',
    shoppingCatLabel: 'Label',
    shoppingCatLabelPlaceholder: 'e.g. Fruit & veg',
    shoppingCatEmoji: 'Emoji',
    shoppingCatEmojiPlaceholder: '🥦',
    shoppingCatMoveUp: 'Move up',
    shoppingCatMoveDown: 'Move down',
    shoppingCatBuiltin: 'Built-in',
    shoppingCatDeleteTitle: 'Delete category',
    shoppingCatDeleteBody: 'Delete “{{label}}”? Items in this category move to “Other”.',
    shoppingCatDeleteConfirm: 'Delete',
    shoppingCatProtected: 'This category cannot be deleted.',
    shoppingCatSaveFailed: 'Category could not be saved.',
    shoppingCatDeleteFailed: 'Category could not be deleted.',
    // Rules card: list, add/edit (upsert), delete.
    shoppingRulesTitle: 'Auto-assignment rules',
    shoppingRulesHint: 'Assigns a category (and emoji) to newly added items automatically, based on their name.',
    shoppingRulesEmpty: 'No rules yet.',
    shoppingRuleAdd: 'Add rule',
    shoppingRuleEdit: 'Edit rule',
    shoppingRuleNew: 'New rule',
    shoppingRuleName: 'Item name',
    shoppingRuleNamePlaceholder: 'e.g. Milk',
    shoppingRuleCategory: 'Category',
    shoppingRuleEmoji: 'Emoji (optional)',
    shoppingRuleSave: 'Save',
    shoppingRuleDeleteTitle: 'Delete rule',
    shoppingRuleDeleteBody: 'Delete the rule for “{{name}}”?',
    shoppingRuleDeleteConfirm: 'Delete',
    shoppingRuleSaveFailed: 'Rule could not be saved.',
    shoppingRuleDeleteFailed: 'Rule could not be deleted.',
  },
  recipes: {
    ...
    importHint: 'Paste the address of a recipe page. We extract the title, ingredients and steps — you review and tweak them in the editor.',
    importUrlLabel: 'Recipe URL',
    importAction: 'Import',
    importing: 'Importing…',
    importNoData: 'No recipe data found on that page. You can create the recipe manually.',
    importFailed: 'Import failed. Please check the URL.',
    minutesAbbr: 'min',
    servingsAbbr: 'serv.',
    prep: 'Prep',
    cook: 'Cook time',
