...
export const de = {
  ...
  time: {
    ...
    // Eintrag splitten (#62), auch laufende Timer (#634)
    split: 'Splitten',
    splitRunning: 'Laufenden Timer splitten',
    ...
    splitPart1: 'Teil 1:',
    splitPart2: 'Teil 2:',
    splitHintRunning: 'Teilt den laufenden Timer an der Trennzeit: Teil 1 wird beendet, der Timer läuft nach der Pause weiter — für die vergessene Pause. Trennzeit und Pause müssen in der Vergangenheit liegen.',
    splitInvalidCut: 'Die Trennzeit muss zwischen Start und Ende liegen',
    splitInvalidCutRunning: 'Die Trennzeit muss zwischen Start und jetzt liegen',
    splitInvalidBreak: 'Pause in Minuten angeben (z. B. 30)',
    splitBreakTooLong: 'Die Pause muss vor dem Ende des Eintrags enden',
    splitBreakTooLongRunning: 'Die Pause muss vor jetzt enden',
  ...
  settings: {
    ...
    // Über-Unterseite (#626): welcher Build läuft hier — Web-App und Backend.
    about: 'Über',
    aboutVersionTitle: 'Version',
    aboutVersionHint: 'Welcher Stand hier gerade läuft. Die Angabe in Klammern ist der Commit des Builds.',
    aboutWeb: 'Web-App',
    aboutBackend: 'Backend',
    aboutBackendUnavailable: 'nicht erreichbar',
    aboutVersionMismatch: 'Web-App und Backend laufen auf unterschiedlichen Versionen. Nach einem Deployment hilft meist ein Neuladen der Seite.',
    time: 'Zeiterfassung',
